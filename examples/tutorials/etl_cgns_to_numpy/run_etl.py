...
"""CGNS to NumPy Tutorial ETL pipeline runner.

This script demonstrates how to instantiate components and use the ETLOrchestrator
to convert CGNS data to NumPy format.

Usage:
    python run_etl.py \\
        etl.source.input_dir=/path/to/cgns_data \\
...
def main(cfg: DictConfig) -> None:
    """Run the CGNS to NumPy tutorial ETL pipeline.

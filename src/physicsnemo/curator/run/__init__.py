...
of a :class:`~physicsnemo.curator.core.base.Pipeline` — optionally in
...
from physicsnemo.curator.run.base import RunBackend, RunConfig
from physicsnemo.curator.run.dask import DaskBackend
from physicsnemo.curator.run.loky import LokyBackend
from physicsnemo.curator.run.prefect import PrefectBackend
from physicsnemo.curator.run.process_pool import ProcessPoolBackend
from physicsnemo.curator.run.sequential import SequentialBackend
from physicsnemo.curator.run.thread_pool import ThreadPoolBackend
...
def register_backend(backend_cls: type[RunBackend]) -> None:
    ...
    Examples
    --------
    >>> from physicsnemo.curator.run import register_backend, RunBackend
    >>> class MyBackend(RunBackend):
    ...     name = "my_backend"

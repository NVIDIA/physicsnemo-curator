...
class TestAnsysRSTHelpers:
    ...
    def test_extract_connectivity(self) -> None:
        ...
        from physicsnemo_curator.domains.mesh.sources.ansys_rst import _extract_connectivity
    ...
    def test_discover_available_results(self) -> None:
        ...
        from physicsnemo_curator.domains.mesh.sources.ansys_rst import _discover_available_results
    ...
    def test_extract_result_field_success(self) -> None:
        ...
        from physicsnemo_curator.domains.mesh.sources.ansys_rst import _extract_result_field
